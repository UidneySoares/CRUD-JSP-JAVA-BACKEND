    ...
    <body>
        ...
        <section>
            <h1 class="title">Deseja realmente alterar?</h1>
                <form method="post" action="exe_alterarDis.jsp">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nome_disciplina" value="<%=request.getParameter("nome_disciplina")%>" >
                    </div>
                    <div>
                        <label for="cargahoraria_disciplina"><b>Carga horária</b></label><br>
                        <input type="text" name="cargahoraria_disciplina" value="<%=request.getParameter("cargahoraria_disciplina")%>" >
                    </div>
                    <div>
